  ...
  return (
    <section className="w-full min-h-[34.583vw] p-8 flex flex-col justify-center items-center bg-gray-100 text-gray-800 relative">
      <div className="relative w-[47.604vw] h-[28.333vw] flex items-center justify-start"> 
        <div className="w-[25.573vw] h-[28.333vw] bg-[#407BFF] rounded-[0.521vw] p-[2vw] z-0"> {/** 1st */}
          <h1 className="font-bold text-white text-[1.458vw]">Contact Us</h1>
          <p className=" text-white text-[0.938vw] mt-[0.5vw]">
            Say Something!
          </p>
          <div className="w-[17.552vw] h-[8.333vw] mt-[1.5vw]">
            {sources.map((client, index) => (
              <div className="flex items-center">
                <Image
                  ...
                  width={10000}
                  height={10000}
                  className={`${client.width} ${client.height} mt-[1.5vw] mr-[0.5vw] object-cover`}
                />
        ...
        <div className="absolute right-[7vw] transform translate-x-[7vw] z-10">
            <Image
                src="/image/location/maps1.png"
                alt="Ornament Background"
                width={10000}
                height={10000}
                className="w-[24.792vw] h-[25.365vw]"
            /> {/** 2nd */}
        </div>
      </div>
    </section>
