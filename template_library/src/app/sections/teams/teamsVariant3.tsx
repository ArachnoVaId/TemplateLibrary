  ...
  return (
    <section className="w-full min-h-[57.708vw] p-8 flex flex-col justify-center items-center bg-white text-gray-800 relative">
      <div className="w-[40vw] h-[8.333vw] flex flex-col items-center justify-center  ">
        <p className="text-[#407BFF] text-[0.833vw]">We're hiring!</p>
        <h1 className="font-bold text-[1.875vw]">Meet the Team</h1>
        <p className="text-[1.042vw] mt-[1vw] text-center">
      ...
      <div className="w-[78.698vw] h-[33.75vw] flex flex-col mt-[2vw]">
        ...
        <div className="flex flex-row items-center justify-between mt-[3.3vw]">
          {sources1.map((client, index) => (
            <div className="w-[17.578vw] h-[15.208vw] flex flex-col items-center bg-[#F9FAFB] p-[1.25vw]">
              <Image
                key={index}
